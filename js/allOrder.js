...
import { getFirestore, collection, getDocs, query, orderBy, limit, limitToLast, startAfter, endBefore,  } from "https://www.gstatic.com/firebasejs/9.17.1/firebase-firestore.js";
...
// Menampilkan Tabel
function readTables() {
    let table = document.getElementById('tbody1all');
    docSnap.forEach((doc) => {
